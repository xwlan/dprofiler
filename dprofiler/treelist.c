...
//
  ...
  //      }
/*
	N.B. The followings are form w2k common ctrl code, it defines some internal
	const for drawing metrics calculation:
...
/*   N.B. How treeview compute text width for drawing.
