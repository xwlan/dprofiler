	...
	)
{
	...
	HANDLE UnloadEvent = INVALID_HANDLE_VALUE;
	HANDLE IndexHandle = INVALID_HANDLE_VALUE;
	HANDLE DataHandle = INVALID_HANDLE_VALUE;
	HANDLE StackHandle = INVALID_HANDLE_VALUE;
	HANDLE ReportHandle = INVALID_HANDLE_VALUE;
	HANDLE ExitProcessEvent = INVALID_HANDLE_VALUE;
	HANDLE ExitProcessAckEvent = INVALID_HANDLE_VALUE;
	PAPS_PROFILE_OBJECT Object = NULL;
	HANDLE SharedObject = INVALID_HANDLE_VALUE;
	PBTR_SHARED_DATA SharedObjectPtr = NULL;
	ULONG Length = 0;
	HANDLE IoObjectHandle = INVALID_HANDLE_VALUE;
	HANDLE IoIrpHandle = INVALID_HANDLE_VALUE;
	HANDLE IoNameHandle = INVALID_HANDLE_VALUE;
	PWSTR IoObjectPath = NULL;
	PWSTR IoIrpPath = NULL;
	PWSTR IoNamePath = NULL;
